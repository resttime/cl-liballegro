...
;;; Generic Handlers
(defgeneric joystick-axis-handler (system))
(defgeneric joystick-button-down-handler (system))
(defgeneric joystick-button-up-handler (system))
(defgeneric joystick-configuration-handler (system))
(defgeneric key-down-handler (system)
  (:method (system)
    (print (cffi:foreign-slot-value (al:event system)
                                    '(:struct al:keyboard-event)
                                    'al::keycode))))
(defgeneric key-char-handler (system))
(defgeneric key-up-handler (system))
(defgeneric mouse-axis-handler (system))
(defgeneric mouse-button-down-handler (system))
(defgeneric mouse-button-up-handler (system))
(defgeneric mouse-enter-display-handler (system))
(defgeneric mouse-leave-display-handler (system))
(defgeneric mouse-warped-handler (system))
(defgeneric timer-handler (system))
(defgeneric display-expose-handler (system))
...
(defgeneric display-lost-handler (system))
(defgeneric display-found-handler (system))
(defgeneric display-switch-in-handler (system))
(defgeneric display-switch-out-handler (system))
(defgeneric display-switch-orientation-handler (system))
