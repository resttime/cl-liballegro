...
;;; Color addon
(defcfun ("al_color_cmyk" color-cymk) :pointer
...
(defcfun ("al_color_hsl" color-hsl) :pointer
...
(defcfun ("al_color_hsl_to_rgb" color-hsl-to-rgb) :void
  ...
  (red :pointer) (green :pointer) (blue :pointer))
(defcfun ("al_color_hsl" color-hsv) :pointer
...
(defcfun ("al_color_hsv_to_rgb" color-hsv-to-rgb) :void
  ...
  (red :pointer) (green :pointer) (blue :pointer))
(defcfun ("al_color_html" color-html) :pointer (string :string))
...
(defcfun ("al_color_name" color-name) :pointer (name :string))
...
(defcfun ("al_color_yuv" color-yuv) :pointer
  (y c-float) (u c-float) (v c-float))
(defcfun ("al_color_yuv_to_rgb" color-yuv-to-rgb) :pointer
  (y c-float) (u c-float) (v c-float)
  (red :pointer) (green :pointer) (blue :pointer))
